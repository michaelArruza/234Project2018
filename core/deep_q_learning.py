...
class DQN(QN):
    ...
    def get_best_action(self, state):
        ...
        action_values = self.sess.run(self.q, feed_dict={self.s: [np.reshape(state, (344,1))]})[0]
    ...
    def update_step(self, t, replay_buffer, lr):
        ...
        fd = {
            # inputs
            self.s: np.reshape(s_batch, (s_batch.shape[0], 344, 1)),
            self.a: a_batch,
            self.r: r_batch,
            self.sp: np.reshape(s_batch, (sp_batch.shape[0], 344, 1)),
