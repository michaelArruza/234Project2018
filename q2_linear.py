...
class Linear(DQN):
    ...
    def add_placeholders_op(self):
       ...
       # nchannels = state_shape[2]
        nchannels = 1
        self.s = tf.placeholder(tf.uint8, shape=[None, player_state, nchannels*config.state_history])
        self.a = tf.placeholder(tf.int32, shape=[None])
        self.r = tf.placeholder(tf.float32, shape=[None])
        self.sp = tf.placeholder(tf.uint8, shape=[None, player_state, nchannels*config.state_history])
